...
![EKS Clusters](screenshots/EKS-clusters.png)
...
![EKS Dashboard](screenshots/EKS-dashboard.png)
...
![Infracost Dashboard](screenshots/Infracost-dashboard.png)
...
![Infracost Autofix PR Request](screenshots/Infracost-AutoFix-PR-request.png)
...
![Infracost FinOps Savings Solution](screenshots/Infracost-FinOps-Savings-Solution.png)
...
![Infracost Issue Explorer Dashboard](screenshots/Infracost-issue-explorer-dashboard.png)
...
![Terraform Cloud States](screenshots/Terraform-cloud-states.png)
...
![Terraform Cloud Output](screenshots/Terraform-cloud-output-2.png)
...
![Terraform OIDC Role Summary](screenshots/Terraform-Oidc-role-summary.png)
...
![TFsec Results](screenshots/TFsec-results.png)
...
![Terraform Destroy Killswitch](screenshots/Terraform-destroy-killswitch.png)
...
![Terraform Destroy Status](screenshots/Terraform-destroy-status.png)
